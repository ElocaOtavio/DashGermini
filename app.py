...
def carregar_dados_operacionais(url, headers):
    try:
        ...
        # CORREÇÃO FINAL: Remover espaços em branco dos nomes dos operadores
        if 'Nome Completo do Operador' in df.columns:
            df['Nome Completo do Operador'] = df['Nome Completo do Operador'].str.strip()
        return df
...
paginas = ["Desempenho por Analista", "Resultados Globais", "Gráficos de CSAT", "Base de Dados"]
